...
class Client:
    ...
    def createWidgets(self):
        ...
        self.setup.grid(row=2, column=2, padx=2, pady=2, sticky='w')
    ...
    def exitClient(self):
        ...
        rate = float(self.counter / self.frameNbr)  # packet lost
        print('-' * 60 + "\nRTP Packet Loss Rate :" + str(rate) + "\n" + '-' * 60)
        print("Data rate: " + str(self.statTotalBytes/self.statTotalPlayTime))
        print("Total Bytes: " + str(self.statTotalBytes))
        print("Total time: " + str(self.statTotalPlayTime))
    ...
    def describeMovie(self):
        ...
        e1 = Label(self.master, text="stream: RTSP and RTP" + "and endcodding: " + encodeing(self.fileName)).grid(row=5,
                                                                                                                  column=3)
